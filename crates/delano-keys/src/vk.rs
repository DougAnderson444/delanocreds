...
use bls12_381_plus::{G1Affine, G1Compressed, G2Affine, G2Compressed};
...
/// Helpful for deserializing from JSON Base64
    ...
    fn from(v: Vec<u8>) -> Self {
        match v.len() {
            ...
            96 => {
                ...
                VKCompressed::G2(g2.expect("it'll be fine, it passed the check").to_bytes())
            }
