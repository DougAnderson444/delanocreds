    ...
    pub mod wit_ui {
      ...
      pub mod wurbo_out {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_render(arg0: i32,arg1: i32,arg2: i32,arg3: i32,arg4: i32,arg5: i32,arg6: i32,arg7: i32,arg8: i32,arg9: i32,arg10: i32,arg11: i32,arg12: i32,arg13: i32,arg14: i32,) -> i32 {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
            ...
            use super::super::super::super::delano::wit_ui::context_types::Context as V16;
            let v16 = match arg0 {
              0 => {
                let e16 = super::super::super::super::delano::wit_ui::context_types::Everything{
                  page: match arg1 {
                    0 => None,
                    1 => {
                      let e = {
                        ...
                        for i in 0..len12 {
                          ...
                          let e12 = {
                            ...
                            super::super::super::super::delano::wit_ui::context_types::Kov{
                              key: wit_bindgen::rt::string_lift(bytes5),
                              op: wit_bindgen::rt::string_lift(bytes8),
                              value: wit_bindgen::rt::string_lift(bytes11),
                            }
                          };
                          result12.push(e12);
                        }
                  ...
                  load: match arg12 {
                    ...
                    1 => {
                      let e = {
                        let len13 = arg14 as usize;
                        let bytes13 = Vec::from_raw_parts(arg13 as *mut _, len13, len13);
              ...
              3 => {
                let e16 = {
                  use super::super::super::super::delano::wit_ui::context_types::Kovindex as V14;
                  let v14 = match arg2 {
                    0 => {
                      let e14 = arg3 as u32;
                      V14::Key(e14)
                  ...
                  let len15 = arg5 as usize;
                  let bytes15 = Vec::from_raw_parts(arg4 as *mut _, len15, len15);
                  ...
                  super::super::super::super::delano::wit_ui::context_types::Kvctx{
                    ...
                    value: wit_bindgen::rt::string_lift(bytes15),
                  }
                };
                V16::Editattribute(e16)
              }
              n => {
                debug_assert_eq!(n, 4, "invalid enum discriminant");
                let e16 = arg1 as u8;
                V16::Editmaxentries(e16)
              }
            };
            let result17 = <_GuestImpl as Guest>::render(v16);
            let ptr18 = _RET_AREA.0.as_mut_ptr() as i32;
            match result17 {
              Ok(e) => { {
                *((ptr18 + 0) as *mut u8) = (0i32) as u8;
                let vec19 = (e.into_bytes()).into_boxed_slice();
                let ptr19 = vec19.as_ptr() as i32;
                let len19 = vec19.len() as i32;
                ::core::mem::forget(vec19);
                *((ptr18 + 8) as *mut i32) = len19;
                *((ptr18 + 4) as *mut i32) = ptr19;
              } },
              Err(e) => { {
                *((ptr18 + 0) as *mut u8) = (1i32) as u8;
                let vec20 = (e.into_bytes()).into_boxed_slice();
                let ptr20 = vec20.as_ptr() as i32;
                let len20 = vec20.len() as i32;
                ::core::mem::forget(vec20);
                *((ptr18 + 8) as *mut i32) = len20;
                *((ptr18 + 4) as *mut i32) = ptr20;
              } },
            };ptr18
          }
