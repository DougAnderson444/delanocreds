    ...
    pub mod wallet {
        ...
        pub mod types {
            ...
            impl ::core::fmt::Debug for VkCompressed {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        VkCompressed::G1(e) => f.debug_tuple("VkCompressed::G1").field(e).finish(),
                        VkCompressed::G2(e) => f.debug_tuple("VkCompressed::G2").field(e).finish(),
                    }
                }
            }
            ...
            impl ::core::fmt::Debug for PedersenCompressed {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    f.debug_struct("PedersenCompressed")
                        .field("h", &self.h)
                        .finish()
                }
            }
        ...
        pub mod actions {
            ...
            pub fn get_nym_proof(nonce: &[u8]) -> Result<NymProofCompressed, _rt::String> {
                unsafe {
                  ...
                  pedersen_open: super::super::super::delano::wallet::types::PedersenOpenCompressed{
                    open_randomness: _rt::Vec::from_raw_parts(l6.cast(), len8, len8),
                    announce_randomness: _rt::Vec::from_raw_parts(l9.cast(), len11, len11),
                  ...
                  pedersen_commit: _rt::Vec::from_raw_parts(l16.cast(), len18, len18),
                  public_key: _rt::Vec::from_raw_parts(l19.cast(), len21, len21),
                  response: _rt::Vec::from_raw_parts(l22.cast(), len24, len24),
            ...
            pub fn offer(
                ...
                unsafe {
                    ...
                    *ptr0.add(52).cast::<*mut u8>() = result13;
                    ...
                    let len17 = vec17.len();
                    let layout17 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec17.len() * 8, 4);
                    ...
                    *ptr0.add(60).cast::<*mut u8>() = result17;
                    ...
                    let len19 = vec19.len();
                    let layout19 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec19.len() * 8, 4);
                    ...
                    *ptr0.add(68).cast::<*mut u8>() = result19;
                    ...
                    let len23 = vec23.len();
                    let layout23 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec23.len() * 12, 4);
                    ...
                    match redact24 {
                        Some(e) => {
                            ...
                            *ptr0.add(96).cast::<*mut u8>() = result30;
                            cleanup_list
                                .extend_from_slice(&[(result28, layout28), (result30, layout30)]);
                        }
                        None => {
                            *ptr0.add(84).cast::<u8>() = (0i32) as u8;
                        }
            ...
            pub fn prove(values: &Provables) -> Result<Proven, _rt::String> {
                unsafe {
                    ...
                    *ptr0.add(44).cast::<*mut u8>() = result12;
                    ...
                    let len14 = vec14.len();
                    let layout14 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec14.len() * 8, 4);
                    ...
                    *ptr0.add(52).cast::<*mut u8>() = result14;
                    ...
                    let len18 = vec18.len();
                    let layout18 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec18.len() * 8, 4);
                    ...
                    *ptr0.add(68).cast::<*mut u8>() = result20;
                    ...
                    let len24 = vec24.len();
                    let layout24 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec24.len() * 12, 4);
                    ...
                    *ptr0.add(76).cast::<*mut u8>() = result24;
                    ...
                    let len27 = vec27.len();
                    let layout27 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec27.len() * 8, 4);
                    let result27 = if layout27.size() != 0 {
                        let ptr = _rt::alloc::alloc(layout27).cast::<u8>();
                        if ptr.is_null() {
                            _rt::alloc::handle_alloc_error(layout27);
                    ...
                    for (i, e) in vec27.into_iter().enumerate() {
                        let base = result27.add(i * 8);
                        {
                            ...
                            let len26 = vec26.len();
                            let layout26 =
                                _rt::alloc::Layout::from_size_align_unchecked(vec26.len() * 8, 4);
                    ...
                    *ptr0.add(84).cast::<*mut u8>() = result27;
                    ...
                    let len29 = vec29.len();
                    let layout29 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec29.len() * 8, 4);
                    ...
                    *ptr0.add(100).cast::<*mut u8>() = ptr30.cast_mut();
                    ...
                    proof: super::super::super::delano::wallet::types::CredProofCompressed{
                      ...
                      witness_pi: _rt::Vec::from_raw_parts(l51.cast(), len53, len53),
                      nym_proof: super::super::super::delano::wallet::types::NymProofCompressed{
                        challenge: _rt::Vec::from_raw_parts(l54.cast(), len56, len56),
                        pedersen_open: super::super::super::delano::wallet::types::PedersenOpenCompressed{
                          open_randomness: _rt::Vec::from_raw_parts(l57.cast(), len59, len59),
                          announce_randomness: _rt::Vec::from_raw_parts(l60.cast(), len62, len62),
                        ...
                        pedersen_commit: _rt::Vec::from_raw_parts(l67.cast(), len69, len69),
                        public_key: _rt::Vec::from_raw_parts(l70.cast(), len72, len72),
                        response: _rt::Vec::from_raw_parts(l73.cast(), len75, len75),
                        damgard: super::super::super::delano::wallet::types::DamgardTransformCompressed{
                          pedersen: super::super::super::delano::wallet::types::PedersenCompressed{
            ...
            pub fn verify(values: &Verifiables) -> Result<bool, _rt::String> {
                unsafe {
                    ...
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 160]);
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    ...
                    *ptr0.add(100).cast::<*mut u8>() = ptr19.cast_mut();
                    ...
                    let super::super::super::delano::wallet::types::PedersenCompressed { h: h21 } =
                        pedersen20;
                    let vec22 = h21;
                    let ptr22 = vec22.as_ptr().cast::<u8>();
                    let len22 = vec22.len();
                    ...
                    *ptr0.add(124).cast::<*mut u8>() = result28;
                    ...
                    let len32 = vec32.len();
                    let layout32 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec32.len() * 12, 4);
                    let result32 = if layout32.size() != 0 {
                        let ptr = _rt::alloc::alloc(layout32).cast::<u8>();
                        if ptr.is_null() {
                            _rt::alloc::handle_alloc_error(layout32);
                    ...
                    *ptr0.add(132).cast::<*mut u8>() = result32;
                    ...
                    for (i, e) in vec36.into_iter().enumerate() {
                        let base = result36.add(i * 8);
                        {
                            ...
                            let len35 = vec35.len();
                            let layout35 =
                                _rt::alloc::Layout::from_size_align_unchecked(vec35.len() * 8, 4);
    ...
    pub mod wit_ui {
        ...
        pub mod wurbo_in {
            ...
            pub type ListenDetails =
                super::super::super::delano::wit_ui::wurbo_types::ListenDetails;
            #[allow(unused_unsafe, clippy::all)]
...
macro_rules! __export_delanocreds_wit_ui_impl {
  ...
  $($path_to_types_root)*::exports::delano::wit_ui::wurbo_out::__export_delano_wit_ui_wurbo_out_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::delano::wit_ui::wurbo_out);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:delanocreds-wit-ui:encoded world"]
#[doc(hidden)]
...
\x05nonce(\x08selected\x09\x04\0\x0bverifiables\x03\03\x03\x01\x19delano:wallet/\
types@0.1.0\x05\0\x02\x03\0\0\x09attribute\x02\x03\0\0\x09provables\x02\x03\0\0\x0b\
...
\0\x0dissuer-public\x01%\x03\x01\x1bdelano:wallet/actions@0.1.0\x05\x0c\x01B\x02\
\x01r\x02\x08selectors\x02tys\x04\0\x0elisten-details\x03\0\0\x03\x01\x1fdelano:\
wit-ui/wurbo-types@0.1.0\x05\x0d\x02\x03\0\x02\x0elisten-details\x01B\x06\x02\x03\
\x02\x01\x0e\x04\0\x0elisten-details\x03\0\0\x01@\x01\x07details\x01\x01\0\x04\0\
\x10addeventlistener\x01\x02\x01@\x01\x07messages\x01\0\x04\0\x04emit\x01\x03\x03\
\x01\x1cdelano:wit-ui/wurbo-in@0.1.0\x05\x0f\x01B\x13\x01r\x03\x04names\x07versi\
ons\x0bdescriptions\x04\0\x04page\x03\0\0\x01k\x01\x01ks\x01r\x02\x04page\x02\x04\
load\x03\x04\0\x0aeverything\x03\0\x04\x01r\x02\x03keys\x05values\x04\0\x09input\
-ctx\x03\0\x06\x01q\x04\x03key\x01y\0\x02op\x01y\0\x05value\x01y\0\x08selected\x01\
y\0\x04\0\x08kovindex\x03\0\x08\x01r\x02\x03idxy\x03val\x09\x04\0\x05entry\x03\0\
\x0a\x01r\x02\x03ctx\x0b\x05values\x04\0\x05kvctx\x03\0\x0c\x01p}\x01r\x03\x04pe\
ers\x05topics\x04data\x0e\x04\0\x07message\x03\0\x0f\x01q\x09\x0ball-content\x01\
