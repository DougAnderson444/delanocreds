...
pub mod exports {
  pub mod delano {
    pub mod wallet {
      ...
      pub mod actions {
        ...
        pub unsafe fn _export_get_nym_proof_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 {let len0 = arg1;
      ...
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn _export_issue_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
    ...
    pub unsafe fn __post_return_issue<T: Guest>(arg0: *mut u8,) {
      ...
      match l0 {
        0 => {
          ...
          let l38 = *arg0.add(64).cast::<*mut u8>();
          let l39 = *arg0.add(68).cast::<usize>();
          let base40 = l38;
          let len40 = l39;
          for i in 0..len40 {
          ...
          let l44 = *arg0.add(72).cast::<*mut u8>();
          let l45 = *arg0.add(76).cast::<usize>();
          let base46 = l44;
          let len46 = l45;
          for i in 0..len46 {
          ...
          let l54 = *arg0.add(80).cast::<*mut u8>();
          let l55 = *arg0.add(84).cast::<usize>();
          let base56 = l54;
          let len56 = l55;
          for i in 0..len56 {
            let base = base56.add(i * 12);
            {
              ...
              match l47 {
                0 => {
                  let l48 = *base.add(4).cast::<*mut u8>();
                  let l49 = *base.add(8).cast::<usize>();
                  let base50 = l48;
                  let len50 = l49;
    ...
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub unsafe fn _export_offer_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(4).cast::<usize>();
    let len2 = l1;
  ...
  #[doc(hidden)]
  #[allow(non_snake_case)]
  pub unsafe fn _export_accept_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(4).cast::<usize>();
  let len2 = l1;
  let l3 = *arg0.add(8).cast::<*mut u8>();
  let l4 = *arg0.add(12).cast::<usize>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_extend_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
let l1 = *arg0.add(4).cast::<usize>();
let len2 = l1;
let l3 = *arg0.add(8).cast::<*mut u8>();
let l4 = *arg0.add(12).cast::<usize>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_prove_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
let l1 = *arg0.add(4).cast::<usize>();
let len2 = l1;
let l3 = *arg0.add(8).cast::<*mut u8>();
let l4 = *arg0.add(12).cast::<usize>();
...
pub unsafe fn __post_return_prove<T: Guest>(arg0: *mut u8,) {
  ...
  match l0 {
    0 => {
      ...
      let len12 = l11;
      _rt::cabi_dealloc(base12, len12 * 1, 1);
      let l16 = *arg0.add(36).cast::<*mut u8>();
      let l17 = *arg0.add(40).cast::<usize>();
      let base18 = l16;
      let len18 = l17;
      for i in 0..len18 {
      ...
      let l53 = *arg0.add(120).cast::<*mut u8>();
      let l54 = *arg0.add(124).cast::<usize>();
      let base55 = l53;
      let len55 = l54;
      for i in 0..len55 {
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_verify_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 {let l0 = *arg0.add(0).cast::<*mut u8>();
let l1 = *arg0.add(4).cast::<usize>();
let len2 = l1;
let l3 = *arg0.add(8).cast::<*mut u8>();
let l4 = *arg0.add(12).cast::<usize>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_issuer_public_cabi<T: Guest>() -> *mut u8 {let result0 = T::issuer_public();
...
pub unsafe fn __post_return_issuer_public<T: Guest>(arg0: *mut u8,) {
  ...
  match l0 {
    0 => {
      ...
      let l20 = *arg0.add(20).cast::<*mut u8>();
      let l21 = *arg0.add(24).cast::<usize>();
      let base22 = l20;
      let len22 = l21;
      for i in 0..len22 {
        let base = base22.add(i * 12);
        {
          ...
          match l13 {
            0 => {
              let l14 = *base.add(4).cast::<*mut u8>();
              let l15 = *base.add(8).cast::<usize>();
              let base16 = l14;
              let len16 = l15;
              _rt::cabi_dealloc(base16, len16 * 1, 1);
            },
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:delanocreds:encoded world"]
#[doc(hidden)]
...
A\x11\x01B\x04\x01p}\x01j\x01\0\x01s\x01@\0\0\x01\x04\0\x08get-seed\x01\x02\x03\x01\
...
fiables\x03\03\x03\x01\x19delano:wallet/types@0.1.0\x05\x01\x02\x03\0\x01\x09att\
ribute\x02\x03\0\x01\x09provables\x02\x03\0\x01\x0bverifiables\x02\x03\0\x01\x0c\
offer-config\x02\x03\0\x01\x0dissue-options\x02\x03\0\x01\x05nonce\x02\x03\0\x01\
\x05entry\x02\x03\0\x01\x06proven\x02\x03\0\x01\x15credential-compressed\x02\x03\
\0\x01\x14nym-proof-compressed\x02\x03\0\x01\x18issuer-public-compressed\x01B.\x02\
\x03\x02\x01\x02\x04\0\x09attribute\x03\0\0\x02\x03\x02\x01\x03\x04\0\x09provabl\
es\x03\0\x02\x02\x03\x02\x01\x04\x04\0\x0bverifiables\x03\0\x04\x02\x03\x02\x01\x05\
\x04\0\x0coffer-config\x03\0\x06\x02\x03\x02\x01\x06\x04\0\x0dissue-options\x03\0\
\x08\x02\x03\x02\x01\x07\x04\0\x05nonce\x03\0\x0a\x02\x03\x02\x01\x08\x04\0\x05e\
ntry\x03\0\x0c\x02\x03\x02\x01\x09\x04\0\x06proven\x03\0\x0e\x02\x03\x02\x01\x0a\
\x04\0\x15credential-compressed\x03\0\x10\x02\x03\x02\x01\x0b\x04\0\x14nym-proof\
-compressed\x03\0\x12\x02\x03\x02\x01\x0c\x04\0\x18issuer-public-compressed\x03\0\
\x14\x01p}\x01j\x01\x13\x01s\x01@\x01\x05nonce\x16\0\x17\x04\0\x0dget-nym-proof\x01\
\x18\x01p\x01\x01k\x09\x01j\x01\x11\x01s\x01@\x03\x0aattributes\x19\x0amaxentrie\
s}\x07options\x1a\0\x1b\x04\0\x05issue\x01\x1c\x01@\x02\x04cred\x11\x06config\x07\
\0\x1b\x04\0\x05offer\x01\x1d\x01@\x01\x05offer\x11\0\x1b\x04\0\x06accept\x01\x1e\
\x01@\x02\x04cred\x11\x05entry\x0d\0\x1b\x04\0\x06extend\x01\x1f\x01j\x01\x0f\x01\
s\x01@\x01\x06values\x03\0\x20\x04\0\x05prove\x01!\x01j\x01\x7f\x01s\x01@\x01\x06\
values\x05\0\"\x04\0\x06verify\x01#\x01j\x01\x15\x01s\x01@\0\0$\x04\0\x0dissuer-\
public\x01%\x04\x01\x1bdelano:wallet/actions@0.1.0\x05\x0d\x04\x01\x1fdelano:wal\
let/delanocreds@0.1.0\x04\0\x0b\x11\x01\0\x0bdelanocreds\x03\0\0\0G\x09producers\
