    ...
    pub mod wallet {
      ...
      pub mod actions {
        ...
        pub trait Guest {
          ...
          fn issuer_public() -> Result<wit_bindgen::rt::vec::Vec::<wit_bindgen::rt::vec::Vec::<u8>>,wit_bindgen::rt::string::String>;
        }
